...
import { TemplateFolder } from "@/module/playground/lib/path-to-json";
...
const WebContainerPreview = ({
  ...
  const getStartCommand = async (webContainerInstance: WebContainer) => {
